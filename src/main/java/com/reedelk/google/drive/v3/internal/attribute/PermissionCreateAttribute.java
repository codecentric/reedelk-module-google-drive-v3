...
import static com.reedelk.google.drive.v3.internal.attribute.PermissionCreateAttribute.*;
...
public class PermissionCreateAttribute extends MessageAttributes {
    ...
    public PermissionCreateAttribute(String fileId, Permission permission) {
